...
object Dependencies {
    ...
    const val RX_ANDROID = "io.reactivex.rxjava2:rxandroid:${BuildDependenciesVersions.RXANDROID}"
    const val RX_JAVA = "io.reactivex.rxjava2:rxjava:${BuildDependenciesVersions.RXJAVA}"
